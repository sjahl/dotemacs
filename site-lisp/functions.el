...
"When in a multi-pane layout, maximize the current pane.
After maximizing, call the function again to return to the old pane
layout."
  (interactive)
...
(global-set-key (kbd "C-c m") 'my-maximize-window)
